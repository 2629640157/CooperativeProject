...
<table width="100%" height="29"  border="0" cellpadding="0" cellspacing="0" background="image/menu_bg.jpg">
 <form name="form1" method="post" action="${pageContext.request.contextPath}/ny/cwgl/chaxungoods">
     <input type="hidden" name="reqType" value="queryDateTime11">
  <tr>
	...
	<table  border="0" align="left" cellpadding="0" cellspacing="0" onClick="test(this)">
           <tr align="left"> 
                  ...
                  <td width="90" class="button" onclick="javascript:bian(2);">
                   ...
                   <td width="90" class="button" onclick="javascript:bian(2);">
                        <a href="xtgl/menu_xtgl.jsp">系统管理</a>
                    </td>        
           </tr>
    </table></td>
