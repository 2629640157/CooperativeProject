...
<head>
  ...
  <script>
    function  getPage(pageNum,totalpage) {
      ...
      window.location.href = "workerAdSvl?reqType=queryworker&pageNum=" + pageNum;
...
<table width="96%" height="30" border="0" align="center" cellpadding="0" cellspacing="0" class="MENU_line">
  <tr>
    <td width="67%" align="right" class="text" nowrap>&nbsp;姓名：
      ...
      <input type="submit" name="searchbtn2" value="新  增" class="button_new"onClick="javascript:location.href='grxx_xz.jsp'" >
...
<table width="96%" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#bdc7d3">
  ...
  <tr align="center" class="td2"  onmouseover="javascript:changeBgColorOnMouseOver(this);" onMouseOut="javascript:changeBgColorOnMouseOut(this);" onDblClick="doDBClick('bl.htm',true,'2');">
    ...
    <td align="center" nowrap><a href="${pageContext.request.contextPath}/ny/rlzy/workerAdSvl?reqType=look&wid=${worker.wid}">查看</a> <a href="${pageContext.request.contextPath}/ny/rlzy/workerAdSvl?reqType=queryById&wid=${worker.wid}">修改</a></td>
  </tr>
  </c:forEach>
</table>
<table width="96%" height="10"  border="0" align="center" cellpadding="0" cellspacing="0">
 ...
 else {this.document.AwaitForm.paginationAction.value='gotoPage';}"  onclick=" gotopage()">前往</a>
