...
<form action="${pageContext.request.contextPath}/ny/xtgl/company" method="post">
...
<table width="79%" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#bdc7d3" class="text_lb">
  <tr bgcolor="#FFFFFF">
    ...
    <td width="40%"><input name="count" type="text" id="textarea4" value="" size="12" class="pi">
      <span class="text"><span class="STYLE3">*
      </span></span></td>
  </tr>
  <tr bgcolor="#FFFFFF">
    <td width="15%" height="79" align="right"><strong>备注：</strong></td>
    <td colspan="3"><textarea name="remake" id="textarea35" cols="60" rows="5" ></textarea></td>
  </tr>
</table>
<br>
<table width="96%" height="30" border="0" align="center" cellpadding="0" cellspacing="0" >
  <tr>
    <td width="67%" align="center" class="text" nowrap><span class="STYLE3">
      <input type="submit" name="searchbtn3" value="保  存" class="button_new" onClick="javascript:alert('充值成功！');">
