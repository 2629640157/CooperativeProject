...
<table width="96%" height="49" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#bdc7d3" class="text_lb">
  ...
  <tr>
    <td width="73" height="23" align="right" bgcolor="#FFFFFF">发送者：</td>
  ...
  <tr>
    <td height="23" align="right" bgcolor="#FFFFFF">接收人：</td>
    <td  bgcolor="#FFFFFF">
      <select size="10"  style="width:120px" name="sender">
    ...
    <td  bgcolor="#FFFFFF">
      <input type="button" value=">" style="width:50px" onclick="rightOne()">
      <br>
      <input type="button" value=">>" style="width:50px" onclick="rightAll()">
      <br>
      <input type="button" value="<" style="width:50px" onclick="leftOne()">
      <br>
      <input type="button" value="<<" style="width:50px" onclick="leftAll()">
    </td>
    <td  bgcolor="#FFFFFF">
...
<table width="96%" height="30" border="0" align="center" cellpadding="0" cellspacing="0" >
  <tr>
    <td width="67%" align="center" class="text" nowrap>
      ...
      <input type="button" name="searchbtn3" value="返  回" class="button_new" onClick="javascript:location.href='gsgl.htm'" >
