...
<form action="${pageContext.request.contextPath}/ny/ywgl/employer" method="post">
    <input type="hidden" VALUE="addEmployer" name="type">
...
<table width="96%" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#bdc7d3" class="text_lb">
    <tr>
        ...
        <td width="15%" bgcolor="#FFFFFF"><input name="ename" type="text" id="textarea40" value="" size="15" class="pi"></td>
        ...
        <td width="13%" bgcolor="#FFFFFF"><input name="eage" type="text" id="textarea" value="" size="15" class="pi"></td>
        <td width="10%" align="right" bgcolor="#FFFFFF">民族：</td>
        <td width="15%" bgcolor="#FFFFFF"><input name="nation" type="text" id="textarea2" value="" size="15" class="pi"></td>
    </tr>
    <tr>
        <td align="right" bgcolor="#FFFFFF">籍贯：</td>
        <td bgcolor="#FFFFFF"><input name="nationplace" type="text" id="textarea5" value="" size="15" class="pi"></td>
        ...
        <td colspan="3" bgcolor="#FFFFFF"><input name="idcard" type="text" id="textarea3" value="" size="40" class="pi"></td>
    </tr>
    <tr>
        <td align="right" nowrap bgcolor="#FFFFFF">工作单位：</td>
        <td colspan="5" bgcolor="#FFFFFF"><input name="workplace" type="text" id="textarea6" value="" size="65" class="pi"></td>
        <td align="right" bgcolor="#FFFFFF">职业：</td>
        <td bgcolor="#FFFFFF"><input name="duty" type="text" id="textarea7" value="" size="15" class="pi"></td>
    </tr>
    <tr>
        <td align="right" nowrap bgcolor="#FFFFFF">合同号：</td>
        <td colspan="5" bgcolor="#FFFFFF"><input name="htnumber" type="text" id="textarea8" value="" size="65" class="pi"></td>
        <td align="right" bgcolor="#FFFFFF">合同期限：</td>
        <td bgcolor="#FFFFFF"><input name="httime" type="text" id="textarea9" value="" size="15" class="pi"></td>
    </tr>
    <tr>
        <td align="right" nowrap bgcolor="#FFFFFF">联系电话：</td>
        <td align="center" bgcolor="#FFFFFF">手机</td>
        <td colspan="4" bgcolor="#FFFFFF"><input name="cellphone" type="text" id="textarea10" value="" size="44" class="pi"></td>
        <td align="right" bgcolor="#FFFFFF">住宅：</td>
        <td bgcolor="#FFFFFF"><input name="address" type="text" id="textarea11" value="" size="15" class="pi"></td>
    </tr>
    <tr>
        <td align="right" nowrap bgcolor="#FFFFFF">户口所在地：</td>
        <td colspan="7" bgcolor="#FFFFFF"><input name="hkaddress" type="text" id="textarea12" value="" size="65" class="pi"></td>
    </tr>
    <tr>
        <td colspan="2" align="right" bgcolor="#FFFFFF">服务处所（地址）：</td>
        <td colspan="6" bgcolor="#FFFFFF"><input name="serviceaddress" type="text" id="textarea13" value="" size="44" class="pi"></td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td colspan="6" bgcolor="#FFFFFF"><input name="content" type="text" id="textarea16" value="" size="44" class="pi"></td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td colspan="6" bgcolor="#FFFFFF"><input name="habit" type="text" id="textarea18" value="" size="44" class="pi"></td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td colspan="7" align="left" bgcolor="#FFFFFF"><input name="require" type="text" id="textarea20" value="" size="65" class="pi"></td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td colspan="7" align="left" bgcolor="#FFFFFF"><input name="time" type="text" id="textarea22" value="" size="65" class="pi"></td>
    </tr>
</table>
<table width="96%" height="30" border="0" align="center" cellpadding="0" cellspacing="0" >
    <tr>
        <td width="67%" align="center" class="text" nowrap><input type="submit" name="searchbtn3" value="保  存" class="button_new" >
            <input type="button" name="searchbtn3" value="返  回" class="button_new" onclick="javascript:location.href='${pageContext.request.contextPath}/ny/ywgl/deal?type=query&pageNow=${pageNow}'" >
